...
namespace ModelLibrary.Models
{
    ...
    public class Block : INotifyPropertyChanged
    {
        ...
        private PropertyObservingDictionary<string, string> parameters;
        ...
        public PropertyObservingDictionary<string, string> Parameters
        {
            get { return parameters ?? (parameters = new PropertyObservingDictionary<string, string>()); }
            set
            {
                if (parameters != value)
                {
